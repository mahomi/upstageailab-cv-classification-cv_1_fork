...
pred_df.to_csv(f"{output_path}/pred_advanced_kfold_tta2_efnv2xl_v2.csv", index=False)

log.info(f"\n✅ Ensemble prediction completed and saved to {output_path}/pred_advanced_kfold_tta2_efnv2xl_v2.csv")
